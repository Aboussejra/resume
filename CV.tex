...
\resumeSubheading
    {Gatewatcher}{Paris, France}
    {Embedded Software Engineer Cybersecurity Applications}{Sep 2024 - Ongoing}
    \resumeItemListStart
      \resumeItem{Platform Integration for Proxmox/Vsphere and AWS SaaS Deployments}
      {Adapt GateWatcher’s platform on both cloud (AWS) and on-premise (Proxmox/Vspherre) environments.
      \\\textbf{Result:} Flexible and automated deployments with CI env for testing}

      \resumeItem{Suricata Bug fixes and Custom Protocol Parser Implementation}
      {Worked on Suricata development with Open Information Security Foundation and implemented custom protocol parsers for specialized data streams.}

      \resumeItem{BDD-Based Software Development for Production Scaling}
      {Wrote BDD specifications and developed automated tests to ensure software robustness to go from the scale-up phase of the company to large-scale production.
      \\\textbf{Result:} Favor stable production deployments at scale.}
    \resumeItemListEnd
