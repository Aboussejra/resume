...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Embedded AI Software Engineer}{Dec 2022 - Present}
      \resumeItemListStart
        \resumeItem{Detection of Fiber Faults in OTDR Traces}
          {Optical Time Domain Reflectometer (OTDR) traces analysis using ML. Creation of Data Pipelines to go from proprietary format (.sor) to ML Exploitable data and Embedded ML Models. Introduction of CI/CD and MLOps principles for embedded ML project.
          \\ \textbf{Result:} MySQL DB, Python ORM (SQLAlchemy) and custom Pytorch/Sklearn code to have independent routines to make transformations between .sor files $\rightarrow$ MySQL DB $\rightarrow$ preprocessed Dataset for ML $\rightarrow$ models and report metrics $\rightarrow$ ONNX models running on our hardware (inference in C).}
        \resumeItem{Fire detection with Distributed Temperature Sensors}
...
\section{Programming Skills}
 \resumeSubHeadingListStart
   \item{
     \textbf{Languages}{: Rust, Python, C, TS/JS, SQL, Bash, Latex}}
     \item{
